...
[Github](https://github.com/gcc-mirror/gcc/blob/master/gcc/d/decl.cc){:target="_blank"}
...
## GCC 코드 분석
Github에 코드가 있었다.  
[Github](https://github.com/gcc-mirror/gcc/tree/master/gcc){:target="_blank"}
...
[Github](https://github.com/gcc-mirror/gcc/blob/master/gcc/ipa-inline.cc){:target="_blank"}
...
[Wikipedia](https://ko.wikipedia.org/wiki/%ED%94%BC%EB%B3%B4%EB%82%98%EC%B9%98_%ED%9E%99){:target="_blank"}  
...
[Github](https://github.com/gcc-mirror/gcc/blob/master/gcc/tree-core.h){:target="_blank"} 
```cpp
unsigned declared_inline_flag : 1;
```

[Github](https://github.com/gcc-mirror/gcc/blob/master/gcc/tree.h){:target="_blank"}
```cpp
...
[Github](https://github.com/gcc-mirror/gcc/blob/master/gcc/opts.cc){:target="_blank"}
