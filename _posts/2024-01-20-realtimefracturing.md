...
- 구현 영상 : [https://www.youtube.com/watch?v=DU3mkiz4B9g](https://www.youtube.com/watch?v=DU3mkiz4B9g){:target="_blank"}
...
## 과제 설계 배경 및 필요성
<p align="center">
<img src = "/assets/gif/fracturing.gif">
</p>
...
## 과제 주요내용
   1) 타겟 논문에 대한 이해 : 타겟 논문에서 제안하는 Real-Time Fracturing 기술의 핵심 개념과 알고리즘을 분석한다.

   2) 구현 : 타겟 논문을 분석한 내용과 관련 코드를 참고하여 실시간 파괴를 위한 언리얼엔진 코드를 작성한다.

   3) 최적화 및 오류 수정 : 구현된 Real-Time Fracturing의 성능을 프로파일링하고, 오류를 검출하여 개선한다.
 
   4) 응용 : 완성된 Real-Time Fracturing을 응용하여 게임을 제작하고 활용에 대한 방안을 고려한다.

## 최종결과물의 목표
   1) 실시간으로 물체가 파쇄되는 패턴을 계산하고 이를 오브젝트에 적용한다.  
   2) 프로세스가 실행되는 동안 목표 프레임을 지키는지 확인한다.  
